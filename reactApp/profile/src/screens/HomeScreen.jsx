...
export default function HomeScreen({ navigate }) {
  ...
  useEffect(() => {
    const rems = JSON.parse(localStorage.getItem("app_reminders") || "[]").map(r => ({ ...r, type: "Reminder for you" }));
    const sched = JSON.parse(localStorage.getItem("app_schedule") || "[]").map(s => ({ ...s, type: "Care giving scheduling" }));
